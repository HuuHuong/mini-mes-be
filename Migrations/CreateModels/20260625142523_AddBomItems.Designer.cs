...
namespace mini_mes_be.Migrations.CreateModels
{
    ...
    [Migration("20260625142523_AddBomItems")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mini_mes_be.Models.BomItem", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("id")
                        .HasName("pk__bom_items");

                    b.HasIndex("material_id")
                        .HasDatabaseName("ix__bom_items_material_id");

                    b.HasIndex("product_id", "material_id")
                        .IsUnique()
                        .HasDatabaseName("ix__bom_items_product_id_material_id");
            ...
            modelBuilder.Entity("mini_mes_be.Models.BomItem", b =>
                {
                    b.HasOne("mini_mes_be.Models.Product", "material")
                        .WithMany("bom_used_in")
                        .HasForeignKey("material_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk__bom_items__products_material_id");
                    ...
                    b.HasOne("mini_mes_be.Models.Product", "product")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk__bom_items__products_product_id");
            ...
            modelBuilder.Entity("mini_mes_be.Models.Product", b =>
                {
                    b.Navigation("bom_items");

                    b.Navigation("bom_used_in");
